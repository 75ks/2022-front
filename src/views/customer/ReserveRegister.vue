<template>
  <div class="w-full h-full">
    <p class="mt-5 mb-10 text-center font-bold text-2xl">予約</p>
    <p class="mb-10 m-auto text-center text-sm">◆予約情報を入力して「登録」ボタンをクリックしてください。</p>
    <div
